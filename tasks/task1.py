    ...
    return html.Div([
        dbc.Row([
            ...
            dbc.Col([
                ...
                html.P(
                    "基于交易记录热力图分析，所有日期的消费活动主要集中在非工作时间的餐饮场所，出现早、中、晚三个高峰，其中周末的消费时段则被压缩在13:00至20:00之间。同时，在1月12日与1月19日凌晨3:00的 Kronos Mart 均出现了违背常规逻辑的异常交易。\n\n",
                ...
                html.P(
                    "对20分钟时间窗口内连续发生的交易进行空间映射分析，揭示了四起在物理现实中根本无法实现的跨城瞬移事件。最为可疑的是，信用卡 9551 仅在1月13日当天就触发了两次这种违背空间规律的跳跃，同时该卡还卷入了前文提及的凌晨3:00幽灵交易事件。\n\n",
                    className="text-justify text-muted"
                ),
                dbc.Card(dbc.CardBody([
